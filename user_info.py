...
class UserInfo(db.Model):
    ...
    def __init__(self, phone_number, bus_transaction_id, policy_reference0,policy_reference1, policy_reference2, policy_sale_reference,external_reference0, external_reference1, external_reference2):
    ...
    def __repr__(self):
        return f'{self.phone_number} {self.bus_transaction_id} {self.policy_reference0} {self.policy_reference1} {self.policy_reference2} {self.policy_sale_reference}'